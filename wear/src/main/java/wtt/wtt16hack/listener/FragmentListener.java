package wtt.wtt16hack.listener;
...
import wtt.wtt16hack.io.Constants;
        ...
        if(myPosition == 1){
            ...
            CountDownTimer timer = new CountDownTimer(11000, 1000) {
                ...
                public void onFinish() {
                    ...
                    ((GridActivity) mActivity).sendaMsgTOPhone("svenimento");
                }
...
//        textView.setVisibility(View.GONE);
            ...
            CountDownTimer timer = new CountDownTimer(11000, 1000) {
                ...
                public void onFinish() {
                    ...
                    ((GridActivity) mActivity).sendaMsgTOPhone("caduta");
                }
